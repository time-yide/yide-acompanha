-- Adiciona o cargo `financeiro` ao canal Geral do Escritório Virtual.
-- O app já libera o canal (ALL_ROLES em src/lib/escritorio/types.ts + nav),
...
-- financeiro entra só em 'geral' (não em comercial/administrativo/audiovisual/designers).
...
begin
  ...
  return case p_channel_kind
    when 'geral' then v_role in (
      ...
      'assessor_ecommerce', 'assistente_ecommerce', 'programacao', 'financeiro'
    )
