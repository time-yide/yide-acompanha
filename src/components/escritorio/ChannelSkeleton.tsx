...
/**
 * Esqueleto do Escritório Virtual (sidebar de canais + área de mensagens).
 * Compartilhado por todos os `loading.tsx` das rotas do escritório
 * (índice, [kind], grupo/[id], dm/[id]) pra o esqueleto aparecer na hora do
 * clique e durante o redirect do índice — sem tela velha congelada.
 */
