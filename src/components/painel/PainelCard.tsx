...
export function PainelCard({ row, userRole, userId }: Props) {
  ...
  // Assessor preenche o painel dos SEUS clientes (sobe cronograma, marca
  // TPG/TPM/GMN). A página já filtra o assessor pros próprios clientes e a RLS
  // reforça a posse, então liberar por role é seguro.
