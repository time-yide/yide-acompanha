  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-2">
        ...
        {gestao && (
          <Link href="/freela-yide/lancadas/pagamentos" className="inline-flex items-center gap-1 rounded-md border px-3 py-1.5 text-sm font-medium text-muted-foreground hover:bg-muted/40 hover:text-foreground">
            Pagamentos <ArrowRight className="h-4 w-4" />
          </Link>
        )}
      </div>
      <div>
