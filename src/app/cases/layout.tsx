    ...
    >
      ...
      <header className="sticky top-0 z-20 bg-neutral-950">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          <Link href="/cases" className="flex items-center gap-3" aria-label="Yide Cases">
            <Image src="/brand/logo-yide.png" alt="Yide Digital" width={90} height={50} priority className="h-9 w-auto" />
            <span className="hidden text-lg font-semibold tracking-tight text-white/45 [font-family:var(--font-display)] sm:inline">Cases</span>
          </Link>
          <nav className="flex items-center gap-5">
            <Link href="/servicos" className="text-sm font-medium text-white/55 transition-colors hover:text-white">
              Serviços
            </Link>
            <Link href="/cases" className="text-sm font-medium text-white/55 transition-colors hover:text-white">
              Cases
            </Link>
